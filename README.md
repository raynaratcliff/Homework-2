...
** added header, navigation links, and photo of myself**

WHEN I click one of the links in the navigation
THEN the UI scrolls to the corresponding section

**Navigation links direct to the corresponding section for "About Me, Work, and Contact Me"** 
 ...
 **Large ICON than the other 2 photos I took from yellowstone** 

WHEN I click on the images of the applications
THEN I am taken to that deployed application
**Takes to the applications for the projects worked past in class or prework. 
